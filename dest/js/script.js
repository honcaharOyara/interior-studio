...
const myModal = new bootstrap.Modal(_refs__WEBPACK_IMPORTED_MODULE_0__["default"].modalCalcWork);

const dropdownElementList = [].slice.call(_refs__WEBPACK_IMPORTED_MODULE_0__["default"].dropdowns);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "fakeSendData": () => (/* binding */ fakeSendData),
/* harmony export */   "filevalidation": () => (/* binding */ filevalidation),
/* harmony export */   "formHandler": () => (/* binding */ formHandler)
/* harmony export */ });
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./refs */ "./src/js/refs.js");
/* harmony import */ var _bootstrap_settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./bootstrap-settings */ "./src/js/bootstrap-settings.js");
...
function formHandler(e) {
  ...
  target.reset();
  _refs__WEBPACK_IMPORTED_MODULE_0__["default"].formWarrior.innerHTML = "File size not more than 10 MB";
  fakeSendData();
}
...
function filevalidation(e) {
  ...
  if (inputFile.files.length > 0) {
    for (let i = 0; i <= inputFile.files.length - 1; i++) {
      ...
      if (fileKbyte >= 10240) {
        _refs__WEBPACK_IMPORTED_MODULE_0__["default"].formWarrior.innerHTML = `<b>${fileName}</b> has ${Math.round(
          fileKbyte / 1024
        )}mb, please try another.`;
        _refs__WEBPACK_IMPORTED_MODULE_0__["default"].formWarrior.classList.add("invalid");
      } else {
        if (_refs__WEBPACK_IMPORTED_MODULE_0__["default"].formWarrior.classList.contains("invalid")) {
          _refs__WEBPACK_IMPORTED_MODULE_0__["default"].formWarrior.classList.remove("invalid");
        }
        _refs__WEBPACK_IMPORTED_MODULE_0__["default"].formWarrior.innerHTML = fileName;
      }
    }
  }
}
...
function fakeSendData() {
  ...
  _bootstrap_settings__WEBPACK_IMPORTED_MODULE_1__.myModal.hide();
  _refs__WEBPACK_IMPORTED_MODULE_0__["default"].modalPreloader.classList.add("show");

  let iintervalId = setInterval(() => {
    _refs__WEBPACK_IMPORTED_MODULE_0__["default"].modalPreloaderLoading.innerHTML = `${counter}%`;
    counter++;
  ...
  setTimeout(() => {
    _refs__WEBPACK_IMPORTED_MODULE_0__["default"].modalPreloaderLoading.style.opacity = "0";
    _refs__WEBPACK_IMPORTED_MODULE_0__["default"].modalPreloaderLogo.style.width = "144px";
  }, 2000);

  setTimeout(() => {
    _refs__WEBPACK_IMPORTED_MODULE_0__["default"].modalPreloader.classList.remove("show");
    _refs__WEBPACK_IMPORTED_MODULE_0__["default"].body.style = "";
    backdrop.remove();
  }, 3000);
}
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  modalPreloaderLogo: document.querySelector(".popup__logo"),
  modalPreloaderLoading: document.querySelector(".popup__loading"),

  formCaclWork: document.querySelector(".js-form-calc"),
  formFileInput: document.querySelector(".js-input-file"),
  formWarrior: document.querySelector(".js-warrior"),
});
...
if (_refs__WEBPACK_IMPORTED_MODULE_0__["default"].newsSlider) {
    const swiper = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](_refs__WEBPACK_IMPORTED_MODULE_0__["default"].newsSlider, {
        speed: 400,
        spaceBetween: 48,
        slidesPerView: 3,
        centeredSlides: true,
...
/* harmony import */ var _swiper_settings__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./swiper-settings */ "./src/js/swiper-settings.js");
/* harmony import */ var _bootstrap_settings__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./bootstrap-settings */ "./src/js/bootstrap-settings.js");
